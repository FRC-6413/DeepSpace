...
public class HatchTwo extends CommandGroup {
  public HatchTwo() {
    addParallel(new SetFirstStage(RobotMap.StageOneHatchTwo));
    addParallel(new SetSecondStage(RobotMap.StageTwoHatchTwo));
